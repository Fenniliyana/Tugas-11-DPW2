...
<body>
                ...
                <div class="col-md-8 mx-auto">
                  <div class="detail_box">
                    ...
                    <p>
                      ...
                      bahkan ada potongan harga untuk pelanggan sejati
                    </p>
                    <a href="">
                      Read More
                    </a>
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <a href="" class="p_name">
                  Electric Treadmill OB-1061 Ergonomic Design for Home Use
                </a>
                <h6 class="p_price">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <a href="" class="p_name">
                  DOMYOS Rowing machine 100 8527501
                </a>
                <h6 class="p_price">
                  <span class="new_price">
                   Rp3.550.000
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="detail-box">
                ...
                <a href="" class="p_name">
                  Cardio Alat Olahraga Masa Kini
                </a>
                <h6 class="p_price">
                  <span class="new_price">
                  Rp2.200.000
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('public')}}/images/pg4.png" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('public')}}/images/pg5.png" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 ">
            <div class="box">
              ...
              <div class="img-box">
                <img src="{{url('public')}}/images/pg6.png" alt="">
              </div>
              <div class="detail-box">
                <span class="p_rating">
                  <a href="">
                ...
                <a href="" class="p_name">
                  Bench Press OB-204 for Home Use Trainee
                </a>
                <h6 class="p_price">
                  <span class="new_price">
                    Rp 6,000,000
  ...
  <section class="why_us_section layout_padding">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-0 col-md-3">
          <div class="box">
            <div class="img-box">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="400" height="350">
        ...
        <div class="col-lg-2 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <svg id="Layer_3" enable-background="new 0 0 64 64" height="450" viewBox="0 0 64 64" width="450" xmlns="http://www.w3.org/2000/svg">
                <g>
        ...
        <div class="col-lg-2 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 400 350" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                <g>
                  <g>
